...
namespace SuperAdventureConsole
{
    class Program
    {
        ...
        private static void Player_OnPropertyChanged(object sneder, PropertyChangedEventArgs e)
        {
        ...
        private static void ParseInput(string input)
        {
            if (input.Contains("help") || input == "?")
            {
                ...
                Console.WriteLine("====================================");
                Console.WriteLine("Stats - Dispaly player information");
            ...
            {
                foreach (InventoryItem i in _player.Inventory)
                {
                    Console.WriteLine("{0}: {1}", i.Description, i.Quantity);
                }
            }
            ...
            else if (input.Contains("attack"))
            {
                ...
                {
                    Console.WriteLine("There is nothing her to attack");
                }
                else
                {
            ...
            else if (input.StartsWith("equip "))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("You equip your {0}", _player.CurrentWeapon);
                    }
                }
            }
            ...
            else if(input == "trade")
            {
                ...
                else
                {
                    ...
                    {
                        foreach(InventoryItem i in _player.Inventory.Where(x => x.Price!= World.UNSELLABLE_ITEM_PRICE))
                        {
                            Console.WriteLine("{0} {1} Price: {2}", i.Quantity, i.Description, i.Price);
                        }
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if(itemToBuy == null)
                            {
                                Console.WriteLine("The vendor does not have any {0}", itemToBuy.Description); 
                            }
                            else
                            {
                                if(_player.Gold < itemToBuy.Price)
                                {
                                    Console.WriteLine("You do not have enough golld to buy a {0}", itemToBuy.Description);
                                }
                                else
                                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("You received {0} gold for your {1}", itemToSell.Price, itemToSell.Details.Name);
                        }
                    }
                }
            }
