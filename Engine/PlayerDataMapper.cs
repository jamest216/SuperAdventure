...
namespace Engine
{
    ...
    {
        private static readonly string _connectionString = "Server=(local);Database=SuperAdventure;Integrated Security = true;  ";

        //private static readonly string _connectionString = "Server=(local);Database=SuperAdventure;User Id=BRI\adminjamest216; Password=BAseball365;";
